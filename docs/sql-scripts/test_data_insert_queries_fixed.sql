-- =====================================================
-- Remit Planner 테스트 데이터 INSERT 쿼리 모음 (수정됨)
-- =====================================================
...
-- 중요: 사용자 ID 변경 필요
-- =====================================================
-- 아래의 UUID들을 실제 Supabase 사용자 ID로 변경하세요:
-- '00000000-0000-0000-0000-000000000001' → 실제 사용자 1의 UUID
-- '00000000-0000-0000-0000-000000000002' → 실제 사용자 2의 UUID
...
('schedule_time_1', '00000000-0000-0000-0000-000000000001', 'schedule_3', '2024-01-30', '09:00', '18:00', 60),
('schedule_time_2', '00000000-0000-0000-0000-000000000001', 'schedule_3', '2024-01-31', '08:00', '17:00', 60),
('schedule_time_3', '00000000-0000-0000-0000-000000000001', 'schedule_3', '2024-02-01', '10:00', '19:00', 60),
('schedule_time_4', '00000000-0000-0000-0000-000000000001', 'schedule_3', '2024-02-02', '07:00', '16:00', 60);
...
('schedule_worker_6', '00000000-0000-0000-0000-000000000001', 'schedule_3', 'worker_1', '2024-01-30', '2024-02-02', false, 15000, 5000, 0, true, true, true, false),
('schedule_worker_7', '00000000-0000-0000-0000-000000000001', 'schedule_3', 'worker_2', '2024-01-30', '2024-02-02', false, 16000, 5000, 2000, true, true, true, false);
...
('schedule_worker_8', '00000000-0000-0000-0000-000000000002', 'schedule_4', 'worker_4', '2024-02-05', '2024-02-05', true, 18000, 6000, 3000, true, true, true, false),
('schedule_worker_9', '00000000-0000-0000-0000-000000000002', 'schedule_4', 'worker_5', '2024-02-05', '2024-02-05', true, 15000, 4000, 1000, true, true, true, false);
...
('worker_time_1', '00000000-0000-0000-0000-000000000001', 'schedule_worker_6', '2024-01-30', '09:00', '18:00', 60),
('worker_time_2', '00000000-0000-0000-0000-000000000001', 'schedule_worker_6', '2024-01-31', '08:00', '17:00', 60),
('worker_time_3', '00000000-0000-0000-0000-000000000001', 'schedule_worker_6', '2024-02-01', '10:00', '19:00', 60),
('worker_time_4', '00000000-0000-0000-0000-000000000001', 'schedule_worker_6', '2024-02-02', '07:00', '16:00', 60),

-- 최영희 (worker_2)의 시간 설정 (다른 시간)
('worker_time_5', '00000000-0000-0000-0000-000000000001', 'schedule_worker_7', '2024-01-30', '10:00', '19:00', 60),
('worker_time_6', '00000000-0000-0000-0000-000000000001', 'schedule_worker_7', '2024-01-31', '09:00', '18:00', 60),
('worker_time_7', '00000000-0000-0000-0000-000000000001', 'schedule_worker_7', '2024-02-01', '11:00', '20:00', 60),
('worker_time_8', '00000000-0000-0000-0000-000000000001', 'schedule_worker_7', '2024-02-02', '08:00', '17:00', 60);
...
('client_doc_1', '00000000-0000-0000-0000-000000000001', 'client_1', '계약서.pdf', 'https://storage.supabase.co/remit-planner-files/clients/ABC_건설/계약서.pdf', 'clients/ABC_건설/계약서.pdf', 'application/pdf', 2048576),
('client_doc_2', '00000000-0000-0000-0000-000000000001', 'client_1', '현장사진1.jpg', 'https://storage.supabase.co/remit-planner-files/clients/ABC_건설/현장사진1.jpg', 'clients/ABC_건설/현장사진1.jpg', 'image/jpeg', 1024000);

-- XYZ 아파트 관련 문서
INSERT INTO client_documents (
  id, user_id, client_id, file_name, file_url, file_path, file_type, file_size
) VALUES 
('client_doc_3', '00000000-0000-0000-0000-000000000001', 'client_2', '리모델링_계약서.pdf', 'https://storage.supabase.co/remit-planner-files/clients/XYZ_아파트/리모델링_계약서.pdf', 'clients/XYZ_아파트/리모델링_계약서.pdf', 'application/pdf', 1536000),
('client_doc_4', '00000000-0000-0000-0000-000000000001', 'client_2', '현장_측량도.pdf', 'https://storage.supabase.co/remit-planner-files/clients/XYZ_아파트/현장_측량도.pdf', 'clients/XYZ_아파트/현장_측량도.pdf', 'application/pdf', 3072000);
...
('schedule_doc_1', '00000000-0000-0000-0000-000000000001', 'schedule_3', '전기_설계도.pdf', 'https://storage.supabase.co/remit-planner-files/schedules/DEF_오피스텔_전기_공사/전기_설계도.pdf', 'schedules/DEF_오피스텔_전기_공사/전기_설계도.pdf', 'application/pdf', 4096000, 'manual'),
('schedule_doc_2', '00000000-0000-0000-0000-000000000001', 'schedule_3', '안전수칙.pdf', 'https://storage.supabase.co/remit-planner-files/schedules/DEF_오피스텔_전기_공사/안전수칙.pdf', 'schedules/DEF_오피스텔_전기_공사/안전수칙.pdf', 'application/pdf', 512000, 'guide'),
('schedule_doc_3', '00000000-0000-0000-0000-000000000001', 'schedule_3', '현장사진.jpg', 'https://storage.supabase.co/remit-planner-files/schedules/DEF_오피스텔_전기_공사/현장사진.jpg', 'schedules/DEF_오피스텔_전기_공사/현장사진.jpg', 'image/jpeg', 2048000, 'photo');
